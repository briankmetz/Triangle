...
public final class Checker implements Visitor {
  ...
  public Object visitEmptyDefaultParameterSequence(EmptyDefaultParameterSequence ast, Object o) {
    return null;
  }

  public Object visitMultipleDefaultParameterSequence(MultipleDefaultParameterSequence ast, Object o) {
    ast.FP.visit(this, null);
  ...
  public Object visitSingleDefaultParameterSequence(SingleDefaultParameterSequence ast, Object o) {
    ast.FP.visit(this, null);
    ast.E.visit(this, null);
    return null;
  }
  ...
  //needs to account for case where APS is longer than the FPS
  ...
  //accepts FPS AND DPS, checks that FPS is empty so that all Actual Parameters have been accepted
  public Object visitEmptyActualParameterSequence(EmptyActualParameterSequence ast, Object o, Object o1) {
    FormalParameterSequence fps = (FormalParameterSequence) o;
  ...
  public Object visitMultipleActualParameterSequence(MultipleActualParameterSequence ast, Object o, Object o1) {
    ...
    DefaultParameterSequence dps = (DefaultParameterSequence) o1;
    if(fps instanceof EmptyFormalParameterSequence){
    	if(!(dps instanceof MultipleDefaultParameterSequence)){
    		reporter.reportError ("too many actual parameters", "", ast.position);
    	}else{
  ...
  public Object visitSingleActualParameterSequence(SingleActualParameterSequence ast, Object o, Object o1) {
    FormalParameterSequence fps = (FormalParameterSequence) o;
    DefaultParameterSequence dps = (DefaultParameterSequence) o1;
    if (fps instanceof MultipleFormalParameterSequence){
  ...
  private ProcDeclaration declareStdProc (String id, FormalParameterSequence fps, DefaultParameterSequence dps) {

    ProcDeclaration binding;

    binding = new ProcDeclaration(new Identifier(id, dummyPos), fps, dps,
  ...
  private FuncDeclaration declareStdFunc (String id, FormalParameterSequence fps, DefaultParameterSequence dps,
                                          TypeDenoter resultType) {

    FuncDeclaration binding;

    binding = new FuncDeclaration(new Identifier(id, dummyPos), fps, dps, resultType,
  ...
  private void establishStdEnvironment () {
    ...
    StdEnvironment.chrDecl = declareStdFunc("chr", new SingleFormalParameterSequence(
                                      new ConstFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos), StdEnvironment.charType);
    StdEnvironment.ordDecl = declareStdFunc("ord", new SingleFormalParameterSequence(
                                      new ConstFormalParameter(dummyI, StdEnvironment.charType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos), StdEnvironment.integerType);
    StdEnvironment.eofDecl = declareStdFunc("eof", new EmptyFormalParameterSequence(dummyPos), new EmptyDefaultParameterSequence(dummyPos), StdEnvironment.booleanType);
    StdEnvironment.eolDecl = declareStdFunc("eol", new EmptyFormalParameterSequence(dummyPos), new EmptyDefaultParameterSequence(dummyPos), StdEnvironment.booleanType);
    StdEnvironment.getDecl = declareStdProc("get", new SingleFormalParameterSequence(
                                      new VarFormalParameter(dummyI, StdEnvironment.charType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos));
    StdEnvironment.putDecl = declareStdProc("put", new SingleFormalParameterSequence(
                                      new ConstFormalParameter(dummyI, StdEnvironment.charType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos));
    StdEnvironment.getintDecl = declareStdProc("getint", new SingleFormalParameterSequence(
                                            new VarFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos));
    StdEnvironment.putintDecl = declareStdProc("putint", new SingleFormalParameterSequence(
                                            new ConstFormalParameter(dummyI, StdEnvironment.integerType, dummyPos), dummyPos), new EmptyDefaultParameterSequence(dummyPos));
    StdEnvironment.geteolDecl = declareStdProc("geteol", new EmptyFormalParameterSequence(dummyPos), new EmptyDefaultParameterSequence(dummyPos));
    StdEnvironment.puteolDecl = declareStdProc("puteol", new EmptyFormalParameterSequence(dummyPos), new EmptyDefaultParameterSequence(dummyPos));
